...
~/.Codex/skills/gstack/bin/gstack-timeline-log '{"skill":"learn","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
...
```bash
eval "$(~/.Codex/skills/gstack/bin/gstack-slug 2>/dev/null)"
~/.Codex/skills/gstack/bin/gstack-learnings-search --limit 20 2>/dev/null || echo "No learnings yet."
```
...
```bash
eval "$(~/.Codex/skills/gstack/bin/gstack-slug 2>/dev/null)"
~/.Codex/skills/gstack/bin/gstack-learnings-search --query "USER_QUERY" --limit 20 2>/dev/null || echo "No matches."
```
...
```bash
eval "$(~/.Codex/skills/gstack/bin/gstack-slug 2>/dev/null)"
~/.Codex/skills/gstack/bin/gstack-learnings-search --limit 100 2>/dev/null
```
...
```bash
eval "$(~/.Codex/skills/gstack/bin/gstack-slug 2>/dev/null)"
~/.Codex/skills/gstack/bin/gstack-learnings-search --limit 50 2>/dev/null
```
...
```bash
~/.Codex/skills/gstack/bin/gstack-learnings-log '{"skill":"learn","type":"TYPE","key":"KEY","insight":"INSIGHT","confidence":N,"source":"user-stated","files":["FILE1"]}'
```
