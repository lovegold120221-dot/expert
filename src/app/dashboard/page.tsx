        ...
        <div className="entry-content">
          ...
          <section className="entry-panel" aria-live="polite">
            {activePanel === "join" ? (
              ...
              <div className="entry-form entry-form--schedule">
                <div>
                ...
                <div className="invite-share-bar">
                  ...
                  <button
                    type="button"
                    className="share-icon-btn share-icon-outlook"
                    onClick={() => {
                      saveAndRemind();
                      window.open(getOutlookLink(), "_blank", "noopener,noreferrer");
                    }}
                    title="Share via Outlook"
                    aria-label="Share via Outlook"
                  >
                    <span className="share-icon-mark share-icon-mark--outlook" aria-hidden>
                      <OutlookIcon />
                    </span>
                    <span>Outlook</span>
                  </button>
